							...
							<div class="col-sm-5 tjleft">
								<div class="changjing clearfix">
									<ul>
										...
										<li class="col-xs-4">
											<a href="javascript:void(null)" class="onchangjing">宾馆</a>
										</li>
										<li class="col-xs-4 ">
											<a href="${pageContext.request.contextPath}/business/qiye.html">企业</a>
										</li>
								...
								<div class="tjshi clearfix">
									...
									<ul>
										<li class="col-xs-3">房间</li>
										<li class="col-xs-9">
											<select id="sltshi" class="form-control">
			...
			<div class="xialaqingdan">
				<div class="container">
								...
								<table class="table table-hover table-bordered">
									...
									<tr>
										...
										<td class="wiauto">
											...
											1.安装在机架上时注意接地<br /> 2.建议对网络划分Vlan 提高网络效率
										</td>
									</tr>
							...
							<div class="table-responsive jieguores3 ">
								<table class="table table-hover table-bordered">
									...
									<tr>
										<td class="wi150"><label class="red">*</label> 备注：</td>
										<td class="wiauto">
											1.为保障实际使用效果，建议每个楼层弱电箱内放置一台<br /> 2.每台设备可为8个AP或监控摄像头提供网络和电源供应
											<br /> 3.若某一层需接入的终端设备超过8台，则需要增加交换机数量或更换交换机型号
										</td>
									</tr>
								...
								<table class="table table-hover table-bordered">
									...
									<tr>
										...
										<td class="wiauto">
											...
											1.为保障实际使用效果，建议四个房间共用一台i9<br /> 2.每台设备可供15个无线客户端接入
											<br /> 3.此AP为入吸顶式安装
										</td>
									</tr>
							...
							<div class="table-responsive jieguores5 ">
								<table class="table table-hover table-bordered">
									<tr>
										...
										<th class="wiauto"><label class="f60">M3</label><em id="tr5em5" class="tdmcolor"></em> 台 <span class="pull-right"><label class="red">*</label>提示：此方案只提供参考，具体部署需根据实际情况而定</span></th>
									</tr>
									<tr>
										<td class="wi150">设备用途：</td>
										<td class="wiauto">
							...
							<div class="table-responsive jieguores5 ">
								<table class="table table-hover table-bordered">
									<tr>
										...
										<th class="wiauto"><label class="f60">W6</label><em id="tr6em6" class="tdmcolor"></em> 台 <span class="pull-right"><label class="red">*</label>提示：此方案只提供参考，具体部署需根据实际情况而定</span></th>
									</tr>
									<tr>
										<td class="wi150">设备用途：</td>
										<td class="wiauto">
									...
									<tr>
										...
										<td class="wiauto">
											...
											1.为保障实际使用效果，建议2个房间共用一台W6<br /> 2.每台设备可为10个无线客户端接入
											<br /> 3.此AP为入墙式安装
										</td>
									</tr>
					...
					<div class="row zhinengtuijian2">
						...
						<div class="jieguoqingdanpic"><img src="statics/images/busiess/zhinengbingguang.jpg" /></div>
