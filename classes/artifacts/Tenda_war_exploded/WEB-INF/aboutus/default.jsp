								...
								<div class="container">
									<div class="row">
										<div class="col-xs-6 col-sm-3">
											<div class="card"><img class="card-icon" src="statics/images/abt1.png" alt="" />
												<div class="card-body">
													<h4 class="card-title">公司成立</h4></div>
											</div>
										</div>
										<div class="col-xs-6 col-sm-3">
											<div class="card"><img class="card-icon" src="statics/images/abt2.png" alt="" />
												<div class="card-body">
													<h4 class="card-title">员工人数</h4></div>
											</div>
										</div>
										<div class="col-xs-6 col-sm-3">
											<div class="card"><img class="card-icon" src="statics/images/abt3.png" alt="" />
												<div class="card-body">
													<h4 class="card-title">年销售额</h4></div>
											</div>
										</div>
										<div class="col-xs-6 col-sm-3">
											<div class="card"><img class="card-icon" src="statics/images/abt4.png" alt="" />
												<div class="card-body">
