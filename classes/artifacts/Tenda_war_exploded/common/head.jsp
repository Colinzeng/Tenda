...
<div class="fixhome">
					...
					<div class="row bgb  clearfix">
						...
						<ul class="navmenu hidden-xs fn-clear">
							<li class=" ForHome navline" _t_nav="proHome">
								<a href="index.html" onclick="_hmt.push(['_trackEvent', '网站主导航_PC', 'click', '家用产品'])">茶产品<i class="caret"></i></a><span class="downarr"></span></li>
							<li class=" ForBusiness navline" _t_nav="proHome">
								<a href="business/default.html" onclick="_hmt.push(['_trackEvent', '网站主导航_PC', 'click', '商用产品'])">茶园管理<i class="caret"></i></a><span class="downarr"></span></li>
							...
							<li class="Profile">
								<a href="aboutus/contact.html" onclick="_hmt.push(['_trackEvent', '网站主导航_PC', 'click', '走进腾达'])">走进德益</a>
							</li>
					...
					<div id="proHome" style="display: none;" _t_nav="proHome" class="clearfix">
						<div class="container ">
							<div class="row dmForhome clearfix">
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=路由器" onclick="_hmt.push(['_trackEvent', '家用产品_下拉菜单_PC', 'click', '绿茶'])"><img src="statics/images/service/103.png" alt="路由器" />绿茶</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=交换机" onclick="_hmt.push(['_trackEvent', '家用产品_下拉菜单_PC', 'click', '交换机'])">
											<img src="statics/images/service/111.png" alt="交换机" />花茶
										</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=无线网卡" onclick="_hmt.push(['_trackEvent', '家用产品_下拉菜单_PC', 'click', '无线网卡'])"><img src="statics/images/service/110.png" alt="无线网卡" />菊花</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=电力线" onclick="_hmt.push(['_trackEvent', '家用产品_下拉菜单_PC', 'click', '电力线'])"><img src="statics/images/service/106.png" alt="电力线" />白茶</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=信号放大器"  onclick="_hmt.push(['_trackEvent', '家用产品_下拉菜单_PC', 'click', '信号放大器'])"><img src="statics/images/service/104.png" alt="信号放大器" />红茶</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=接入终端"  onclick="_hmt.push(['_trackEvent', '家用产品_下拉菜单_PC', 'click', '接入终端'])"><img src="statics/images/service/158.png" alt="接入终端" />茶具</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=网络摄像机"  onclick="_hmt.push(['_trackEvent', '家用产品_下拉菜单_PC', 'click', '网络摄像机'])"><img src="statics/images/service/197.png" alt="网络摄像机" />茶叶副产品</a>
									</div>
									<ul></ul>
								</div>
							</div>
							<div class="row dmForbussiness clearfix">
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=企业无线路由器"  onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_PC', 'click', '企业无线路由器'])"><img src="statics/images/service/201.png" alt="企业无线路由器" />茶叶批发</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=企业无线AP" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_PC', 'click', '无线AP'])"><img src="statics/images/service/186.png" alt="无线AP" />茶叶惠条</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=企业交换机" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_PC', 'click', '交换机'])"><img src="statics/images/service/189.png" alt="交换机" />茶叶加工机器</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=企业AP控制器" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_PC', 'click', 'AP控制器'])"><img src="statics/images/service/169.png" alt="AP控制器" />茶园观光</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=企业路由器" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_PC', 'click', '企业路由器'])"><img src="statics/images/service/182.png" alt="企业路由器" />绿色果蔬</a>
									</div>
									<ul></ul>
								</div>
								<div class="w8w">
									<div class="thumbnail">
										<a href="${pageContext.request.contextPath}/pro_product.html?type=企业综合布线及其它" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_PC', 'click', '综合布线及其它'])"><img src="statics/images/service/204.png" alt="综合布线及其它" />绿色鱼肉</a>
									</div>
									<ul></ul>
								</div>
							</div>
		...
		<div class="nav-phone hidden-sm hidden-md hidden-lg hidden"><b></b>
			<ul style="display: block;">
				...
				<li class="menu01">
					<a href="business/default.html">茶园管理</a>
					<ul class="ul01 hidden">
						<li class="menu02">
							<a href="${pageContext.request.contextPath}/pro_product.html?type=企业无线路由器" title="企业无线路由器" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_移动', 'click', '企业无线路由器'])">茶叶批发</a>
						</li>
						<li class="menu02">
							<a href="${pageContext.request.contextPath}/pro_product.html?type=无线AP" title="无线AP" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_移动', 'click', '无线AP'])">茶叶惠条</a>
						</li>
						<li class="menu02">
							<a href="${pageContext.request.contextPath}/pro_product.html?type=交换机" title="交换机" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_移动', 'click', '交换机'])">茶叶加工机器</a>
						</li>
						<li class="menu02">
							<a href="${pageContext.request.contextPath}/pro_product.html?type=AP控制器" title="AP控制器" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_移动', 'click', 'AP控制器'])">茶园观光</a>
						</li>
						<li class="menu02">
							<a href="${pageContext.request.contextPath}/pro_product.html?type=企业路由器" title="企业路由器" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_移动', 'click', '企业路由器'])">绿色果蔬</a>
						</li>
						<li class="menu02">
							<a href="${pageContext.request.contextPath}/pro_product.html?type=综合布线及其它" title="综合布线及其它" onclick="_hmt.push(['_trackEvent', '商用产品_下拉菜单_移动', 'click', '综合布线及其它'])">绿色鱼肉</a>
						</li>
					</ul>
				</li>
				<li class="menu01">
				...
				<li class="menu01">
					<a href="aboutus/contact.html">走进德益</a>
					<ul class="ul01 hidden">
						<li class="menu02">
