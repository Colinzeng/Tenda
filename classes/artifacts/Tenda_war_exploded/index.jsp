				...
				<div class="container  clearfix">
					<div class="row">
						<div class="main-category-item    bl0  active   ">
							<div class="line"></div>
							<p class="main-category-name">绿茶</p>
						</div>
						<div class="main-category-item     ">
							<div class="line"></div>
							<p class="main-category-name">花茶</p>
						</div>
						<div class="main-category-item     ">
							<div class="line"></div>
							<p class="main-category-name">菊花</p>
						</div>
						<div class="main-category-item     ">
							<div class="line"></div>
							<p class="main-category-name">白茶</p>
						</div>
						<div class="main-category-item      hidden-xs ">
							<div class="line"></div>
							<p class="main-category-name">红茶</p>
						</div>
					</div>
				</div>
			</div>
